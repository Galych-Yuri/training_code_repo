...
print(os.listdir(concurrent_directory))  # яки файли чи папки є в середині. Я так розумію повертає список з назвами. А список це ітерований обʼєкт. Тож його можна парсити.
...
як їх підтягувати?
pip install -r 1.txt - ця піпка залізе в куди вказали і сам підтягне та встановить потрібні бібліотеки.
Тому такі файли називають README?
"""
